...
// Helper function outside component to calculate time
...
export function DealTimer({
  ...
  const [timeRemaining, setTimeRemaining] = useState<TimeRemaining>(() => getTimeRemaining(endTime));
  ...
  }, [isClient, endTime, onExpire, refreshInterval]);
    ...
    <div className={cn('space-y-2', className)}>
      ...
      <div className="flex items-center space-x-2">
        ...
        <TimeUnit
          ...
          label={showLabels ? 'Minutes' : ''}
          isUrgent={timeRemaining.isUrgent}
        />
        <Separator isUrgent={timeRemaining.isUrgent} />
        <TimeUnit
          value={formatTimeUnit(timeRemaining.seconds)}
          label={showLabels ? 'Seconds' : ''}
          isUrgent={timeRemaining.isUrgent}
        />
      </div>
