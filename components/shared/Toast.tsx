...
export function ToastProvider({ children }: { children: ReactNode }) {
  ...
  // ✅ THIS is where useEffect belongs
  useEffect(() => {
    ...
    return () => window.removeEventListener('xarastore-toast', handler);
  }, []);
