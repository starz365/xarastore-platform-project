...
export default async function DealsPage() {
  const [deals, dealCategories] = await Promise.all([
    getDeals(),
    getDealCategories(),
  ]);

  const featuredDeals = deals.filter(deal => deal.is_featured).slice(0, 8);
        ...
        <div className="container-responsive py-12 md:py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Button asChild variant="outline" size="lg" className="text-white border-white">
                <a href="#ending-soon">
      ...
      <section id="ending-soon" className="py-12">
        <div className="container-responsive">
          <div className="flex items-center justify-between mb-8">
            ...
            <Button asChild variant="link" href="/deals/ending-soon">
              View All
            </Button>
          </div>
      ...
      <section className="py-12 bg-white border-t border-gray-200">
        <div className="container-responsive">
          ...
          <Suspense fallback={<ProductGridSkeleton count={12} />}>
            {deals.length > 0 ? (
              <ProductGrid products={deals.slice(0, 12)} />
            ) : (
              <EmptyDealsState
