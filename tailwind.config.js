  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'xara-bounce': 'xara-bounce 1s ease-in-out infinite',
        'xara-shimmer': 'xara-shimmer 2s infinite',
        'xara-spin': 'xara-spin 1s linear infinite',
        'xara-gradient-shift': 'xara-gradient-shift 3s ease infinite',
